                    ...
                    <table class="table align-middle table-nowrap ">
                        <tbody>
                            <tr>
                                <td style="width: 50px;">
                                    <div class="avatar-md me-4">
                                        <img src="{{ URL::asset('./dasson/images/product/img-1.png') }}"
                                            class="img-fluid" alt="">
                                    </div>
                                </td>
                                ...
                                <td>
                                    <div>
                                        <h5 class="font-size-15"><a href="" class="text-dark">Half sleeve T-shirt</a>
                                        </h5>
                            ...
                            <tr>
                                <td style="width: 50px;">
                                    <div class="avatar-md me-4">
                                        <img src="{{ URL::asset('./dasson/images/product/img-2.png') }}"
                                            class="img-fluid" alt="">
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td style="width: 50px;">
                                    <div class="avatar-md me-4">
                                        <img src="{{ URL::asset('./dasson/images/product/img-3.png') }}"
                                            class="img-fluid" alt="">
                                    </div>
                                </td>
                                ...
                                <td>
                                    <div>
                                        <h5 class="font-size-15"><a href="" class="text-dark">Black Color T-shirt</a>
                                        </h5>
                            ...
                            <tr>
                                <td style="width: 50px;">
                                    <div class="avatar-md me-4">
                                        <img src="{{ URL::asset('./dasson/images/product/img-4.png') }}"
                                            class="img-fluid" alt="">
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td style="width: 50px;">
                                    <div class="avatar-md me-4">
                                        <img src="{{ URL::asset('./dasson/images/product/img-5.png') }}"
                                            class="img-fluid" alt="">
                                    </div>
                                </td>
                                ...
                                <td>
                                    <div>
                                        <h5 class="font-size-15"><a href="" class="text-dark"></a>Half sleeve T-Shirt
                                        </h5>
                            ...
                            <tr>
                                <td style="width: 50px;">
                                    <div class="avatar-md me-4">
                                        <img src="{{ URL::asset('./dasson/images/product/img-6.png') }}"
                                            class="img-fluid" alt="">
                                    </div>
                                </td>
                                ...
                                <td>
                                    <div>
                                        <h5 class="font-size-15"><a href="" class="text-dark"></a>Green color T-shirt
                                        </h5>
                    ...
                    <ul class="list-unstyled mb-0">
                        ...
                        <li>
                            <div class="conversation-list">
                                <div class="d-flex">
                                    <img src="{{ URL::asset('dasson/images/users/avatar-3.jpg') }}"
                                                ...
                                                <ul class="list-inline message-img mt-3  mb-0">
                                                    <li class="list-inline-item message-img-list">
                                                        <a class="d-inline-block m-1" href="">
                                                            <img src="{{ URL::asset('dasson/images/small/img-1.jpg') }}"
                                                    ...
                                                    <li class="list-inline-item message-img-list">
                                                        <a class="d-inline-block m-1" href="">
                                                            <img src="{{ URL::asset('dasson/images/small/img-2.jpg') }}"
                                                                alt="" class="rounded img-thumbnail">
                                                        </a>
                                                    </li>
                                                </ul>
