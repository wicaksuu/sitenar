...
@section('title') Daftar Perusahaan @endsection
@section('css')
...
@slot('li_1') Daftar Perusahaan @endslot
        ...
        <div class="card mb-0">
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <div class="mb-3">
                            <h5 class="card-title">Daftar Perusahaan <span
                                    class="text-muted fw-normal ms-2">(834)</span>
                            </h5>
                        </div>
                    </div>
                    ...
                    <table class="table align-middle datatable dt-responsive table-check nowrap"
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <img src="{{ URL::asset('dasson/images/users/avatar-2.jpg') }}" alt=""
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="{{ URL::asset('dasson/images/users/avatar-1.jpg') }}" alt=""
                                        class="avatar-sm rounded-circle me-2">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="avatar-sm d-inline-block align-middle me-2">
                                        <div
                                            class="avatar-title bg-soft-primary text-primary font-size-20 m-0 rounded-circle">
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="{{ URL::asset('dasson/images/users/avatar-6.jpg') }}" alt=""
                                        class="avatar-sm rounded-circle me-2">
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="{{ URL::asset('dasson/images/users/avatar-8.jpg') }}" alt=""
                                        class="avatar-sm rounded-circle me-2">
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="{{ URL::asset('dasson/images/users/avatar-9.jpg') }}" alt=""
                                        class="avatar-sm rounded-circle me-2">
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="{{ URL::asset('dasson/images/users/avatar-4.jpg') }}" alt=""
                                        class="avatar-sm rounded-circle me-2">
