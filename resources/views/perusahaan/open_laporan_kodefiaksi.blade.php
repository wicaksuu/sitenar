        ...
        <div class="card-body">
            <div class="row">
                <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input name="kode_pendaftaran" type="text"
                           ...
                           value="{{ str_replace('"','',$perusahaan->kode_pendaftaran) }}"
                            readonly />
                    </div>
                </div>
                <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input name="name" type="text" readonly value="{{ str_replace('"','',$perusahaan->name) }}"
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        <label>No Tlp</label>
                        <input name="no_tlp" type="text" readonly value="{{ str_replace('"','',$perusahaan->no_tlp) }}"
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input name="wa" type="text" readonly value="{{ str_replace('"','',$perusahaan->wa) }}"
                            data-pristine-min-message="Mohon Masukkan Alamat Perusahaan" readonly required
                            class="form-control" />
                    </div>
                </div>
                <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input name="jenis_usaha" type="text" readonly value="{{ str_replace('"','',$perusahaan->jenis_usaha) }}"
                            data-pristine-min-message="Mohon Masukkan Alamat Perusahaan" readonly required
                            class="form-control" />
                    </div>
                </div>
                <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input name="alamat" type="text" readonly value="{{ str_replace('"','',$perusahaan->alamat) }}"
                            data-pristine-min-message="Mohon Masukkan Alamat Perusahaan" readonly required
                            class="form-control" />
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input name="kode_pos" type="text" readonly value="{{ str_replace('"','',$perusahaan->kode_pendaftaran) }}" required
                            class="form-control" />
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input name="nama_pemilik_usaha" type="text" readonly
                            value="{{ str_replace('"','',$perusahaan->nama_pemilik_usaha) }}"
                            data-pristine-min-message="Mohon Masukkan Alamat Perusahaan" required
                            class="form-control" />
                    </div>
                </div>
                <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input name="alamat_pemilik_usaha" type="text" readonly
                            value="{{ str_replace('"','',$perusahaan->alamat_pemilik_usaha) }}"
                            data-pristine-min-message="Mohon Masukkan Alamat Perusahaan" required
                            class="form-control" />
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input name="nomor_akte_pendirian" type="text"
                            value="{{ str_replace('"','',$perusahaan->nomor_akte_pendirian) }}"
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input name="pendirian_perusahaan" value="{{ str_replace('"','',$perusahaan->pendirian_perusahaan) }}" id="startDate" class="form-control"
                            type="date" />
                    </div>
                </div>
                <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input name="perpindahan_perusahaan" value="{{ str_replace('"','',$perusahaan->perpindahan_perusahaan) }}" id="startDate" class="form-control" type="date" />
                    </div>
                </div>
                <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <select name="status_perusahaan" required class="form-control form-select">
                            <option value="{{ str_replace('"','',$perusahaan->status_perusahaan) }}">{{
                        str_replace('"','',$perusahaan->status_perusahaan) }}
                        </option>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input name="jumlah_cabang_di_indonesia" type="number"
                            value="{{ str_replace('"','',$perusahaan->jumlah_cabang_di_indonesia) }}" required
                            class="form-control" />
                    </div>
                </div>
                <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input name="jumlah_cabang_di_luar_indonesia" type="number" value="{{ str_replace('"','',$perusahaan->jumlah_cabang_di_luar_indonesia) }}"
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <select name="status_kepemilikan" required class="form-control form-select">
                            <option value="{{ str_replace('"','',$perusahaan->status_kepemilikan) }}">{{
                        str_replace('"','',$perusahaan->status_kepemilikan) }}</option>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <select name="status_permodalan" required class="form-control form-select">
                            <option value="{{ str_replace('"','',$perusahaan->status_permodalan) }}">{{
                        str_replace('"','',$perusahaan->status_permodalan) }}</option>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input name="asal_negara" type="text" value="{{ str_replace('"','',$perusahaan->asal_negara) }}"
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <select name="waktu_kerja" required class="form-control form-select">
                            <option value="{{ str_replace('"','',$perusahaan->waktu_kerja) }}">{{
                        str_replace('"','',$perusahaan->waktu_kerja) }}</option>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <select name="sektor_pertambangan" class="form-control form-select">
                            <option value="{{ str_replace('"','',$perusahaan->sektor_pertambangan) }}">{{
                        str_replace('"','',$perusahaan->sektor_pertambangan) }}</option>
                            <option
                                value=" Minimal 10 minngu berturut-turut dengan 2 minggu berturut-turut istirahat, dan
                                setiap 2 minggu dalam periode kerja diberikan 1 hari istirahat">
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <select name="sektor_esdm" class="form-control form-select">
                            <option value="{{ str_replace('"','',$perusahaan->sektor_esdm) }}">{{
                        str_replace('"','',$perusahaan->sektor_esdm) }}</option>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <select name="sektor_perikanan" class="form-control form-select">
                            <option value="{{ str_replace('"','',$perusahaan->sektor_perikanan) }}">{{
                        str_replace('"','',$perusahaan->sektor_perikanan) }}</option>
                            <option
                                value=" Periode kerja 3 minggu berturut-turut, dengan ketentuan setelah pekerja bekerja
                                selama 2 minggu berturut-turut diberikan 1 hari istirahat serta 4 hari istirahat setelah
                                pekerja menyelesaikan periode kerja">
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <select name="instalasi_pengolahan_limbah" class="form-control form-select">
                            <option value="{{ str_replace('"','',$perusahaan->instalasi_pengolahan_limbah) }}">{{
                        str_replace('"','',$perusahaan->instalasi_pengolahan_limbah) }}</option>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <select name="pihak_ketiga" class="form-control form-select">
                            <option value="{{ str_replace('"','',$perusahaan->pihak_ketiga) }}">{{
                        str_replace('"','',$perusahaan->pihak_ketiga) }}</option>
                            <option value=" Ada">Ada</option>
                            <option value="Tidak Ada">Tidak Ada</option>
                        </select>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input name="tingkat_upah_terendah" type="text"
                            value="{{ str_replace('"','',$perusahaan->tingkat_upah_terendah) }}"
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input name="tingkat_upah_tertinggi" type="text" value="{{ str_replace('"','',$perusahaan->tingkat_upah_tertinggi) }}"
                    ...
                    <div class="form-group mb-3">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" id="q" type="checkbox"
                                ...
                                @if (preg_match("/Peralatan Perlindungan/i", $perusahaan->fasilitas_keselamatan_dan_kesehatan)) {{'checked' }} @endif 
                    ...
                    <div class="form-group mb-3">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" id="w" type="checkbox"
                                ...
                                @if (preg_match("/Penyelenggaraan Makanan/i", $perusahaan->fasilitas_keselamatan_dan_kesehatan)) {{'checked' }} @endif/>
                    ...
                    <div class="form-group mb-3">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" id="qq" type="checkbox"
                                ...
                                @if (preg_match("/Pelayanan Kesehatan/i", $perusahaan->fasilitas_keselamatan_dan_kesehatan)) {{'checked' }} @endif />
                    ...
                    <div class="form-group mb-3">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" id="qqq" type="checkbox"
                                ...
                                @if (preg_match("/Peralatan Pelindung/i", $perusahaan->fasilitas_keselamatan_dan_kesehatan)) {{'checked' }} @endif/>
                    ...
                    <div class="form-group mb-3">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" id="qw" type="checkbox"
                                ...
                                @if (preg_match("/Ruang PK3/i", $perusahaan->fasilitas_keselamatan_dan_kesehatan)) {{'checked' }} @endif/>
                    ...
                    <div class="form-group mb-3">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" id="dsaj" type="checkbox"
                                ...
                                @if (preg_match("/Kotak P3K/i", $perusahaan->fasilitas_keselamatan_dan_kesehatan)) {{'checked' }} @endif/>
                    ...
                    <div class="form-group mb-3">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" id="adsjh" type="checkbox"
                                ...
                                @if (preg_match("/Alat Pelindung Diri/i", $perusahaan->fasilitas_keselamatan_dan_kesehatan)) {{'checked' }} @endif/>
                    ...
                    <div class="form-group mb-3">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" id="sadkj" type="checkbox"
                                ...
                                @if (preg_match("/Penanganan Limbah/i", $perusahaan->fasilitas_keselamatan_dan_kesehatan)) {{'checked' }} @endif/>
                    ...
                    <div class="form-group mb-3">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" id="qdas" type="checkbox" name="fasilitas_kesejahteraan[]"
                                ...
                                @if (preg_match("/Keluarga Berencana/i", $perusahaan->fasilitas_kesejahteraan)) {{'checked' }} @endif/>
                    ...
                    <div class="form-group mb-3">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" id="dsakj" type="checkbox" name="fasilitas_kesejahteraan[]"
                                value="Tempat Penitipan Anak" @if (preg_match("/Tempat Penitipan Anak/i", $perusahaan->fasilitas_kesejahteraan)) {{'checked' }} @endif/>
                    ...
                    <div class="form-group mb-3">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" id="aosiri" type="checkbox" name="fasilitas_kesejahteraan[]"
                                value="Perumahan Pekerja" @if (preg_match("/Perumahan Pekerja/i", $perusahaan->fasilitas_kesejahteraan)) {{'checked' }} @endif/>
                    ...
                    <div class="form-group mb-3">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" id="wqieu" type="checkbox" name="fasilitas_kesejahteraan[]"
                                value="Fasilitas Ibadah" @if (preg_match("/Fasilitas Ibadah/i", $perusahaan->fasilitas_kesejahteraan)) {{'checked' }} @endif/>
                    ...
                    <div class="form-group mb-3">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" id="owierpqiw" type="checkbox"
                                name="fasilitas_kesejahteraan[]" value="Kantin/Catering" @if (preg_match("/Catering/i", $perusahaan->fasilitas_kesejahteraan)) {{'checked' }} @endif/>
                    ...
                    <div class="form-group mb-3">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" id="iwqeoi" type="checkbox" name="fasilitas_kesejahteraan[]"
                                value="Fasilitas Rekreasi" @if (preg_match("/Fasilitas Rekreasi/i", $perusahaan->fasilitas_kesejahteraan)) {{'checked' }} @endif/>
                    ...
                    <div class="form-group mb-3">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" id="sdmnal" type="checkbox" name="fasilitas_kesejahteraan[]"
                                value="Koperasi" @if (preg_match("/Koperasi/i", $perusahaan->fasilitas_kesejahteraan)) {{'checked' }} @endif/>
                    ...
                    <div class="form-group mb-3">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" id="saurai" type="checkbox" name="fasilitas_kesejahteraan[]"
                                value="Fasilitas Laktasi" @if (preg_match("/Fasilitas Laktasi/i", $perusahaan->fasilitas_kesejahteraan)) {{'checked' }} @endif/>
                    ...
                    <div class="form-group mb-3">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" id="asf" type="checkbox" name="fasilitas_kesejahteraan[]"
                                value="Ruang Merokok" @if (preg_match("/Ruang Merokok/i", $perusahaan->fasilitas_kesejahteraan)) {{'checked' }} @endif/>
                    ...
                    <div class="form-group mb-3">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" id="qewe" type="checkbox" name="fasilitas_kesejahteraan[]"
                                value="Armada Antar Jemput" @if (preg_match("/Armada Antar Jemput/i", $perusahaan->fasilitas_kesejahteraan)) {{'checked' }} @endif/>
                    ...
                    <div class="form-group mb-3">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" id="qweoi" type="checkbox" name="fasilitas_kesejahteraan[]"
                                value="Fasilitas Kesenian" @if (preg_match("/Fasilitas Kesenian/i", $perusahaan->fasilitas_kesejahteraan)) {{'checked' }} @endif/>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input name="nomor_bpjs" type="text" required value="{{ str_replace('"','',$perusahaan->nomor_bpjs) }}" readonly
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input name="program_jaminan_kesehatan" type="number" required value="{{ str_replace('"','',$perusahaan->program_jaminan_kesehatan) }}"
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input name="program_jkk" type="number" required value="{{ str_replace('"','',$perusahaan->program_jkk) }}"
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input name="program_jht" type="number" required value="{{ str_replace('"','',$perusahaan->program_jht) }}"
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input name="program_jkm" type="number" required value="{{ str_replace('"','',$perusahaan->program_jkm) }}"
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input name="program_jp" type="number" required value="{{ str_replace('"','',$perusahaan->program_jp) }}"
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <select name="perangkat_hubungan_kerja" class="form-control form-select">
                            <option value="{{ str_replace('"','',$perusahaan->perangkat_hubungan_kerja) }}">{{
                        str_replace('"','',$perusahaan->perangkat_hubungan_kerja) }}</option>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <select name="perangkat_organisasi_keterangan" class="form-control form-select">
                            <option value="{{ str_replace('"','',$perusahaan->perangkat_organisasi_keterangan) }}">{{
                        str_replace('"','',$perusahaan->perangkat_organisasi_keterangan) }}</option>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <select name="sudah_mempunyai_perencanaan_tenaga_kerja" class="form-control form-select">
                            <option value="{{ str_replace('"','',$perusahaan->sudah_mempunyai_perencanaan_tenaga_kerja) }}">{{
                                                    str_replace('"','',$perusahaan->sudah_mempunyai_perencanaan_tenaga_kerja) }}</option>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input name="rencana_jumlah_pekerja" type="number" placeholder="Jumlah pekerja" value="{{ str_replace('"','',$perusahaan->rencana_jumlah_pekerja) }}"
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input name="rencana_jumlah_pekerja_laki_laki" type="number" value="{{ str_replace('"','',$perusahaan->rencana_jumlah_pekerja_laki_laki) }}"
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input name="rencana_jumlah_pekerja_perempuan" type="number" value="{{ str_replace('"','',$perusahaan->rencana_jumlah_pekerja_perempuan) }}"
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        <label>Jumlah Pekerja</label>
                        <input name="jumlah_pekerja_terakhir" type="number" placeholder="Jumlah pekerja" value="{{ str_replace('"','',$perusahaan->jumlah_pekerja_terakhir) }}"
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        <label>Jumlah Pekerja Laki-Laki</label>
                        <input name="jumlah_pekerja_laki_laki_terakhir" type="number" value="{{ str_replace('"','',$perusahaan->jumlah_pekerja_laki_laki_terakhir) }}"
                            placeholder="Jumlah pekerja laki-laki"
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        <label>Jumlah Pekerja Perempuan</label> 
                        <input name="jumlah_pekerja_perempuan_terakhir" type="number" value="{{ str_replace('"','',$perusahaan->jumlah_pekerja_perempuan_terakhir) }}"
                            placeholder="Jumlah pekerja perempuan"
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input name="jumlah_penerimaan_pekerja_dalam_12_bulan_terakhir" type="number"
                            placeholder="Jumlah pekerja" value="{{ str_replace('"','',$perusahaan->jumlah_penerimaan_pekerja_dalam_12_bulan_terakhir) }}"
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input name="jumlan_pekerja_yang_berhenti_dalam_12_bulan_terakhir" type="number"
                            placeholder="Jumlah pekerja" value="{{ str_replace('"','',$perusahaan->jumlan_pekerja_yang_berhenti_dalam_12_bulan_terakhir) }}"
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <select name="program_pelatihan_bagi_pekerja" class="form-control form-select">
                               <option value="{{ str_replace('"','',$perusahaan->program_pelatihan_bagi_pekerja) }}">{{
                                                    str_replace('"','',$perusahaan->program_pelatihan_bagi_pekerja) }}</option>
                            <option value="Ada">Ada</option>
                            <option value="Tidak Ada">Tidak Ada</option>
                        </select>
                    </div>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <select name="program_pemagangan" class="form-control form-select">
                            <option value="{{ str_replace('"','',$perusahaan->program_pemagangan) }}">{{
                                                    str_replace('"','',$perusahaan->program_pemagangan) }}</option>
                            <option value="Ada">Ada</option>
                            <option value="Tidak Ada">Tidak Ada</option>
                        </select>
                    </div>
